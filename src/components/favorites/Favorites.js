...
export default function Favorites({ icon, iconActive }) {
  ...
  return (
    <Button
      as={Link}
      to="/favoritos"
      className="p-2 border-transparent border-b-2 hover:border-primary focus:border-primary focus:outline-none transition-all duration-250 ease-in-out focus-visible:outline focus-visible:outline-2"
